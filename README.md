...
ubuntu20下运行，读取yaml文件时报错，原因是系统安装的opencv版本和ros的版本有冲突导致的:

1)先将camera_models和vins_estimator下的CMakeLists.txt中制定opencv版本为ros的opencv版本:

find_package(OpenCV 4.2.0 REQUIRED)

2)https://blog.csdn.net/m0_52457734/article/details/125343557: 十分有效

其他)

https://blog.csdn.net/qq_52068373/article/details/127871743

https://blog.csdn.net/weixin_43196818/article/details/124514966
